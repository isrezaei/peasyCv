export const fa = {
  ...
  design: {
    ...
    columnStyle: "سبک ستون",
    columnStyleHint: "کلاسیک: ستون چسبیده به لبهٔ صفحه. مدرن: گوشه‌های گرد و کمی فاصله از لبه‌ها.",
    columnStyleClassic: "کلاسیک",
    columnStyleModern: "مدرن",
